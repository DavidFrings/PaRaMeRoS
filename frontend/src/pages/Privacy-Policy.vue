...
<template>
  <main id="privacy-policy">
    ...
    <p>Stand: 17. August 2025</p>
    <br />
    <h3>Inhaltsübersicht</h3>
    <ul class="index">
      <li><a class="index-link" href="#1">Präambel</a></li>
      <li><a class="index-link" href="#2">Verantwortlicher</a></li>
      <li><a class="index-link" href="#3">Übersicht der Verarbeitungen</a></li>
      <li><a class="index-link" href="#4">Maßgebliche Rechtsgrundlagen</a></li>
      <li><a class="index-link" href="#5">Sicherheitsmaßnahmen</a></li>
      <li><a class="index-link" href="#6">Übermittlung von personenbezogenen Daten</a></li>
      <li>
        <a class="index-link" href="#7"
          >Allgemeine Informationen zur Datenspeicherung und Löschung</a
        >
      </li>
      <li><a class="index-link" href="#8">Rechte der betroffenen Personen</a></li>
      <li>
        <a class="index-link" href="#9">Bereitstellung des Onlineangebots und Webhosting</a>
      </li>
      <li><a class="index-link" href="#10">Einsatz von Cookies</a></li>
      <li><a class="index-link" href="#11">Blogs und Publikationsmedien</a></li>
      <li><a class="index-link" href="#12">Kontakt- und Anfrageverwaltung</a></li>
      <li>
        <a class="index-link" href="#13">Plug-ins und eingebettete Funktionen sowie Inhalte</a>
      </li>
      <li><a class="index-link" href="#14">Änderung und Aktualisierung</a></li>
    </ul>
    <br />
    <h3 id="2">Verantwortlicher</h3>
    <p>
      Erzbischöfliche Pater-Rupert-Mayer Realschule<br />Wolfratshauserstr. 30<br />82049 Pullach im
      Isartal
    </p>
    ...
    <br />
    <h3 id="4">Maßgebliche Rechtsgrundlagen</h3>

    <h4>Maßgebliche Rechtsgrundlagen nach der DSGVO:</h4>
    <p>
    ...
    <ul>
      <li>
        <b>Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO)</b> - Die betroffene Person hat ihre
      ...
      <li>
        <b>Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO)</b>
      ...
      <li>
        <b>Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO)</b> - die Verarbeitung ist zur
    ...
    <p>
      Diese Datenschutzhinweise dienen sowohl der Informationserteilung nach dem Schweizer DSG als
      auch nach der Datenschutzgrundverordnung (DSGVO). Aus diesem Grund bitten wir Sie zu beachten,
      dass aufgrund der breiteren räumlichen Anwendung und Verständlichkeit die Begriffe der DSGVO
      ...
      sowie "berechtigtes Interesse" und "besondere Kategorien von Daten" verwendet. Die gesetzliche
      Bedeutung der Begriffe wird jedoch im Rahmen der Geltung des Schweizer DSG weiterhin nach dem
      Schweizer DSG bestimmt.
    </p>
    <br />

    <h3 id="5">Sicherheitsmaßnahmen</h3>
    <p>
    ...
    <h3 id="6">Übermittlung von personenbezogenen Daten</h3>
    <p>
      ...
      übermittelt beziehungsweise ihnen gegenüber offengelegt werden. Zu den Empfängern dieser Daten
      können z.B. mit IT-Aufgaben beauftragte Dienstleister gehören oder Anbieter von Diensten und
    ...
    <p>
      ...
      Abteilungen oder Einheiten innerhalb unserer Organisation übermitteln oder ihnen den Zugriff
      darauf gewähren. Sofern die Datenweitergabe zu administrativen Zwecken erfolgt, beruht sie auf
      unseren berechtigten unternehmerischen und betriebswirtschaftlichen Interessen oder erfolgt,
      sofern sie zur Erfüllung unserer vertragsbezogenen Verpflichtungen erforderlich ist
      beziehungsweise wenn eine Einwilligung der Betroffenen oder eine gesetzliche Erlaubnis
      vorliegt.
    </p>
    <br />

    <h3 id="7">Allgemeine Informationen zur Datenspeicherung und Löschung</h3>
    <p>
    ...
    <p>
      ...
      längste Frist maßgeblich. Daten, die nicht mehr für den ursprünglich vorgesehenen Zweck,
      sondern aufgrund gesetzlicher Vorgaben oder anderer Gründe aufbewahrt werden, verarbeiten wir
    ...
    <h3 id="8">Rechte der betroffenen Personen</h3>
    <p>
    ...
    <ul>
      <li>
        <b
          ...
          Profiling, soweit es mit solcher Direktwerbung in Verbindung steht.</b
        >
      </li>
      <li>
        <b>Widerrufsrecht bei Einwilligungen:</b> Sie haben das Recht, erteilte Einwilligungen
        jederzeit zu widerrufen.
      </li>
      <li>
        <b>Auskunftsrecht:</b> Sie haben das Recht, eine Bestätigung darüber zu verlangen, ob
      ...
      <li>
        <b>Recht auf Berichtigung:</b> Sie haben entsprechend den gesetzlichen Vorgaben das Recht,
        die Vervollständigung der Sie betreffenden Daten oder die Berichtigung der Sie betreffenden
        unrichtigen Daten zu verlangen.
      </li>
      <li>
        <b>Recht auf Löschung und Einschränkung der Verarbeitung:</b> Sie haben nach Maßgabe der
      ...
      <li>
        <b>Recht auf Datenübertragbarkeit:</b> Sie haben das Recht, Sie betreffende Daten, die Sie
      ...
      <li>
        <b>Beschwerde bei Aufsichtsbehörde:</b> Sie haben unbeschadet eines anderweitigen
    ...
    <h3 id="9">Bereitstellung des Onlineangebots und Webhosting</h3>
    <p>
    ...
    <ul>
      <li>
        <b>Verarbeitete Datenarten:</b> Nutzungsdaten (z. B. Seitenaufrufe und Verweildauer,
      ...
      <li>
        <b>Zwecke der Verarbeitung:</b> Bereitstellung unseres Onlineangebotes und
      ...
      <li>
        <b>Aufbewahrung und Löschung:</b> Löschung entsprechend Angaben im Abschnitt "Allgemeine
    ...
    <ul>
      <li>
        <b>Bereitstellung Onlineangebot auf gemietetem Speicherplatz: </b>Für die Bereitstellung
        unseres Onlineangebotes nutzen wir Speicherplatz, Rechenkapazität und Software, die wir von
        einem entsprechenden Serveranbieter (auch "Webhoster" genannt) mieten oder anderweitig
        beziehen;
        <span
          ><b>Rechtsgrundlagen:</b> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</span
        >
      </li>
      <li>
        <b>Erhebung von Zugriffsdaten und Logfiles: </b>Der Zugriff auf unser Onlineangebot wird in
        ...
        <span
          ><b>Rechtsgrundlagen:</b> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO). </span
        ><b>Löschung von Daten:</b> Logfile-Informationen werden für die Dauer von maximal 30 Tagen
      ...
      <li>
        <b>Content-Delivery-Network: </b>Wir setzen ein "Content-Delivery-Network" (CDN) ein. Ein
        ...
        das Internet verbundener Server schneller und sicherer ausgeliefert werden können;
        <span
          ><b>Rechtsgrundlagen:</b> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</span
        >
      </li>
      <li>
        <b>STRATO: </b>Leistungen auf dem Gebiet der Bereitstellung von informationstechnischer
        Infrastruktur und verbundenen Dienstleistungen (z.B. Speicherplatz und/oder
        Rechenkapazitäten); <b>Dienstanbieter:</b> STRATO AG, Pascalstraße 10,10587 Berlin,
        Deutschland;
        <span
          ><b>Rechtsgrundlagen:</b> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span
        ><b>Website: </b> <a href="https://www.strato.de" target="_blank">https://www.strato.de</a>;
    ...
    <br />
    <h3 id="10">Einsatz von Cookies</h3>
    <p>
      ...
      Informationen unerlässlich ist, um ausdrücklich angeforderte Inhalte und Funktionen
      bereitstellen zu können. Dazu zählen etwa die Speicherung von Einstellungen sowie die
      Sicherstellung der Funktionalität und Sicherheit unseres Onlineangebots. Die Einwilligung kann
      jederzeit widerrufen werden. Wir informieren klar über deren Umfang und welche Cookies genutzt
      werden.
    </p>
    <p>
      <b>Hinweise zu datenschutzrechtlichen Rechtsgrundlagen: </b>Ob wir personenbezogene Daten
      mithilfe von Cookies verarbeiten, hängt von einer Einwilligung ab. Liegt eine Einwilligung
    ...
    <p>
      <b>Speicherdauer: </b>Im Hinblick auf die Speicherdauer werden die folgenden Arten von Cookies
      unterschieden:
    </p>
    <ul>
      <li>
        <b>Temporäre Cookies (auch: Session- oder Sitzungscookies):</b> Temporäre Cookies werden
      ...
      <li>
        <b>Permanente Cookies:</b> Permanente Cookies bleiben auch nach dem Schließen des Endgeräts
    ...
    <p>
      <b>Allgemeine Hinweise zum Widerruf und Widerspruch (Opt-out): </b>Nutzer können die von ihnen
    ...
    <b>Cookie-Einstellungen/-Widerspruchsmöglichkeit:</b>
    <p><a href="https://parameros.net/cookies" target="_blank">Cookies</a></p>
    <ul>
      <li>
        <b>Verarbeitete Datenarten:</b> Meta-, Kommunikations- und Verfahrensdaten (z. B.
    ...
    <ul>
      <li>
        <b>Verarbeitung von Cookie-Daten auf Grundlage einer Einwilligung: </b>Wir setzen eine
        ...
        Einwilligungserklärungen werden gespeichert, um eine erneute Abfrage zu vermeiden und den
        ...
        mittels vergleichbarer Technologien, um die Einwilligung einem spezifischen Nutzer oder
        dessen Gerät zuordnen zu können. Sofern keine spezifischen Angaben zu den Anbietern von
        Einwilligungs-Management-Diensten vorliegen, gelten folgende allgemeine Hinweise: Die Dauer
        der Speicherung der Einwilligung beträgt bis zu zwei Jahre. Dabei wird ein pseudonymer
        Nutzer-Identifikator erstellt, der zusammen mit dem Zeitpunkt der Einwilligung, den Angaben
        zum Umfang der Einwilligung (z.B. betreffende Kategorien von Cookies und/oder
        Diensteanbieter) sowie Informationen über den Browser, das System und das verwendete
        Endgerät gespeichert wird;
        <span><b>Rechtsgrundlagen:</b> Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO).</span>
      </li>
    </ul>
    <br />
    <h3 id="11">Blogs und Publikationsmedien</h3>
    <p>
    ...
    <ul>
      <li>
        <b>Verarbeitete Datenarten:</b> Bestandsdaten (z.B. der vollständige Name, Wohnadresse,
      ...
      <li>
        <b>Zwecke der Verarbeitung:</b> Feedback (z.B. Sammeln von Feedback via Online-Formular);
    ...
    <ul>
      <li>
        <b>Kommentare und Beiträge: </b>Wenn Nutzer Kommentare oder sonstige Beiträge hinterlassen,
        können ihre IP-Adressen auf Grundlage unserer berechtigten Interessen gespeichert werden.
        Das erfolgt zu unserer Sicherheit, falls jemand in Kommentaren und Beiträgen widerrechtliche
        Inhalte hinterlässt (Beleidigungen, verbotene politische Propaganda etc.). In diesem Fall
        können wir selbst für den Kommentar oder Beitrag belangt werden und sind daher an der
        Identität des Verfassers interessiert.<br />Des Weiteren behalten wir uns vor, auf Grundlage
        unserer berechtigten Interessen die Angaben der Nutzer zwecks Spamerkennung zu
        verarbeiten.<br />Auf derselben Rechtsgrundlage behalten wir uns vor, im Fall von Umfragen
        die IP-Adressen der Nutzer für deren Dauer zu speichern und Cookies zu verwenden, um
        Mehrfachabstimmungen zu vermeiden.<br />Die im Rahmen der Kommentare und Beiträge
    ...
    <br />
    <h3 id="12">Kontakt- und Anfrageverwaltung</h3>
    <p>
    ...
    <ul>
      ...
      <li>
        <b>Zwecke der Verarbeitung:</b> Kommunikation; Organisations- und Verwaltungsverfahren;
    ...
    <ul>
      <li>
        <b>Kontaktformular: </b>Bei Kontaktaufnahme über unser Kontaktformular, per E-Mail oder
        anderen Kommunikationswegen, verarbeiten wir die uns übermittelten personenbezogenen Daten
        zur Beantwortung und Bearbeitung des jeweiligen Anliegens. Dies umfasst in der Regel Angaben
        wie Name, Kontaktinformationen und gegebenenfalls weitere Informationen, die uns mitgeteilt
        werden und zur angemessenen Bearbeitung erforderlich sind. Wir nutzen diese Daten
        ausschließlich für den angegebenen Zweck der Kontaktaufnahme und Kommunikation;
        <span
          ><b>Rechtsgrundlagen:</b> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S.
          1 lit. b) DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</span
        >
      </li>
    </ul>
    <br />
    <h3 id="13">Plug-ins und eingebettete Funktionen sowie Inhalte</h3>
    <p>
    ...
    <p>
      <b>Hinweise zu Rechtsgrundlagen:</b> Sofern wir die Nutzer um ihre Einwilligung in den Einsatz
      ...
      In diesem Zusammenhang möchten wir Sie auch auf die Informationen zur Verwendung von Cookies
    ...
    <ul>
      ...
      <li>
        ...
        Jahren (Sofern nicht anders angegeben, können Cookies und ähnliche Speichermethoden für
        einen Zeitraum von zwei Jahren auf den Geräten der Nutzer gespeichert werden.).
      </li>
      <li>
        <b>Rechtsgrundlagen:</b> Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO). Berechtigte
    ...
    <ul>
      <li>
        <b>Google Fonts (Bezug vom Google Server): </b>Bezug von Schriften (und Symbolen) zum Zwecke
        einer technisch sicheren, wartungsfreien und effizienten Nutzung von Schriften und Symbolen
        ...
        erstellen oder zielgerichtete Anzeigen zu schalten; <b>Dienstanbieter:</b> Google Ireland
        ...
        >; <b>Grundlage Drittlandtransfers: </b> Data Privacy Framework (DPF).
    ...
    <br />
    <h3 id="14">Änderung und Aktualisierung</h3>
    <p>
